...
class Employe(models.Model):
    ...
    isDeleted = models.BooleanField(default= False )
    nombreAbscence = models.PositiveIntegerField(null=True)
    demandeAvance = models.BooleanField(default= False )
    def __str__(self):
        return str(self.nom)    
...
class Absence(models.Model):
    ...
    def update_employe_absence_count(sender, instance, **kwargs):
        employe = instance.employe
        employe.nombreAbscence = Absence.objects.filter(employe=employe).count()
        employe.save()
